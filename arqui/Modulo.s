...
//
// Formula:
//   MEDIA_PONDERADA = S(Xi * Wi) / S(Wi)
//   Wi = 1, 2, 3, ..., 30  (pesos crecientes)
//   S(Wi) = 465             (suma fija 1+2+...+30)
//
// Compilar (en Raspberry Pi o con cross-compiler):
